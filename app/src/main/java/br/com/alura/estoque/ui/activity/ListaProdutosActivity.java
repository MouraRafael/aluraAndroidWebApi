        ...
        adapter.setOnItemClickRemoveContextMenuListener((
                (posicao, produtoEscolhido) ->
                        repository.remove(produtoEscolhido, new ProdutoRepository.DadosCarregadosCallback<Void>() {
                            ...
                            @Override
                            public void quandoFalha(String erro) {
                                Toast.makeText(ListaProdutosActivity.this,"Não foi possível remover o produto", Toast.LENGTH_LONG).show();
                            }
                        })
        ));
    }
    ...
    private void abreFormularioEditaProduto(int posicao, Produto produto) {
        new EditaProdutoDialog(this, produto,
                produtoCriado -> repository.edita(produtoCriado, new ProdutoRepository.DadosCarregadosCallback<Produto>() {
                    ...
                    @Override
                    public void quandoFalha(String erro) {
                        Toast.makeText(ListaProdutosActivity.this, "Não foi possível editar o produto", Toast.LENGTH_LONG).show();
                    }
                }))
                .mostra();
    }
